...
export type AdminNavLink = { href: string; label: string; icon?: string } // icon = SVG path `d`
...
export const DEFAULT_ADMIN_NAV: AdminNavSection[] = [
          ...
          <div class="admin-wrapper">
            <aside class="admin-sidebar">
              <div class="sidebar-header">
                <h1>
                  <a href="/admin">
                    <span class="logo-icon">{brandLogo}</span>
                    {brandName}
                  </a>
                </h1>
              </div>
                        ...
                        <a href={l.href}>
                          {l.icon && (
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d={l.icon}></path>
                            </svg>
                          )}
                          {l.label}
                        </a>
              ...
              <div class="sidebar-footer">
                ...
                <form action="/admin/logout" method="post">
                  <button type="submit" class="btn btn-sm" style="width: 100%; background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.8); border: 1px solid rgba(255,255,255,0.1);">
                    Logout
                  </button>
                </form>
              </div>
