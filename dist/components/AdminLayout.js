...
const ICON = {
    ...
    articles: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253",
...
export const DEFAULT_ADMIN_NAV = [
    { title: "Overview", links: [{ href: "/admin", label: "Dashboard", icon: ICON.dashboard }] },
    {
        title: "Content",
        links: [
            { href: "/admin/pages", label: "Pages", icon: ICON.pages },
            { href: "/admin/projects", label: "Projects", icon: ICON.projects },
            { href: "/admin/articles", label: "Articles", icon: ICON.articles },
            { href: "/admin/team", label: "Team", icon: ICON.team },
        ],
    },
    {
        title: "System",
...
// Exposed so consumers can reuse the stock icon set when building a custom nav.
export const ADMIN_ICONS = ICON;
export const AdminLayout = ({ title = "Admin", username, children, nav = DEFAULT_ADMIN_NAV, brand, }) => {
    const brandName = brand?.name ?? "Admin";
    const brandLogo = brand?.logo ?? "CMS";
